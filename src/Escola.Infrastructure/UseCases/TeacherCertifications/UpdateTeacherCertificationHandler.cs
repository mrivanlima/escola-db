...
public class UpdateTeacherCertificationHandler : IUpdateTeacherCertificationHandler
{
    private readonly EscolaDbContext _context;
    private readonly ICurrentUserService _currentUserService;

    public UpdateTeacherCertificationHandler(EscolaDbContext context, ICurrentUserService currentUserService)
    {
        _context = context;
        _currentUserService = currentUserService;
    }

    public async Task<UpdateTeacherCertificationResponse> HandleAsync(UpdateTeacherCertificationRequest request, CancellationToken cancellationToken)
    {
        ...
        teacherCertification.ObtainedDate = request.TeacherCertification.ObtainedDate;
        teacherCertification.ExpiryDate = request.TeacherCertification.ExpiryDate;
        teacherCertification.CredentialNumber = request.TeacherCertification.CredentialNumber;
        teacherCertification.Notes = request.TeacherCertification.Notes;
        teacherCertification.UpdatedAt = DateTimeOffset.UtcNow;
        teacherCertification.UpdatedBy = _currentUserService.GetCurrentUserId();

        await _context.SaveChangesAsync(cancellationToken);

        return new UpdateTeacherCertificationResponse
        {
