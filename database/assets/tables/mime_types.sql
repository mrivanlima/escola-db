...
CREATE TABLE IF NOT EXISTS assets.mime_types (
    ...
    category        TEXT NOT NULL, -- 'image', 'video', 'audio', 'document'
    ...
    CONSTRAINT ck_mime_types_category CHECK (category IN ('image', 'video', 'audio', 'document')),
...
CREATE INDEX IF NOT EXISTS idx_mime_types_category ON assets.mime_types(category);
...
COMMENT ON COLUMN assets.mime_types.category IS 'High-level category: image, video, audio, document';
...
INSERT INTO assets.mime_types (mime_type_code, mime_type_name, category, file_extension, max_file_size_mb, icon_name, created_by)
VALUES 
    -- Images
    ('image/jpeg', 'JPEG Image', 'image', '.jpg', 10, 'image_icon', 1),
    ('image/png', 'PNG Image', 'image', '.png', 10, 'image_icon', 1),
    ('image/gif', 'GIF Image', 'image', '.gif', 5, 'image_icon', 1),
    ('image/webp', 'WebP Image', 'image', '.webp', 10, 'image_icon', 1),
    ('image/svg+xml', 'SVG Vector', 'image', '.svg', 2, 'vector_icon', 1),
    
    -- Videos
    ('video/mp4', 'MP4 Video', 'video', '.mp4', 100, 'video_icon', 1),
    ('video/webm', 'WebM Video', 'video', '.webm', 100, 'video_icon', 1),
    ('video/ogg', 'Ogg Video', 'video', '.ogv', 100, 'video_icon', 1),
    ('video/quicktime', 'QuickTime Video', 'video', '.mov', 100, 'video_icon', 1),
    
    -- Audio
    ('audio/mpeg', 'MP3 Audio', 'audio', '.mp3', 20, 'audio_icon', 1),
    ('audio/wav', 'WAV Audio', 'audio', '.wav', 20, 'audio_icon', 1),
    ('audio/ogg', 'Ogg Audio', 'audio', '.ogg', 20, 'audio_icon', 1),
    ('audio/mp4', 'M4A Audio', 'audio', '.m4a', 20, 'audio_icon', 1),
    ('audio/webm', 'WebM Audio', 'audio', '.weba', 20, 'audio_icon', 1),
    
    -- Documents
    ('application/pdf', 'PDF Document', 'document', '.pdf', 25, 'pdf_icon', 1),
    ('application/msword', 'Word Document', 'document', '.doc', 25, 'doc_icon', 1),
    ('application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'Word Document (DOCX)', 'document', '.docx', 25, 'doc_icon', 1),
    ('application/vnd.ms-powerpoint', 'PowerPoint', 'document', '.ppt', 50, 'ppt_icon', 1),
    ('application/vnd.openxmlformats-officedocument.presentationml.presentation', 'PowerPoint (PPTX)', 'document', '.pptx', 50, 'ppt_icon', 1)
